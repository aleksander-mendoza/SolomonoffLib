...
public class MealyTest {
    ...
    static class TestCase {
        ...
        private final Class<? extends Throwable> exceptionDuringInversion;
        ...
        public TestCase(String regex, String[] eqRegex, Positive[] positive,Inverted[] invertedPositive, String[] negative, Class<? extends Throwable> exception,
                        Class<? extends Throwable> exceptionAfterMin,Class<? extends Throwable> exceptionDuringInversion, int numStates, boolean skipGenerator,
            ...
            this.exceptionDuringInversion = exceptionDuringInversion;
    ...
    static TestCase ex(String regex, Class<? extends Throwable> exception, Class<? extends Throwable> exceptionAfterMin) {
        ...
        return new TestCase(regex, eq(), null, null,null, exception, exceptionAfterMin,null, -1,  false,false);
    }
    static TestCase exAfterInv(String regex, int states, Positive[] positive, Class<? extends Throwable> exceptionAfterInv,String... negative) {
        assert exceptionAfterInv != null;
        return new TestCase(regex, eq(), positive, invert(positive),negative, null, null,exceptionAfterInv, states,  false,false);
    }

    static TestCase exAfterInv(String regex, Positive[] positive, Class<? extends Throwable> exceptionAfterInv,String... negative) {
        assert exceptionAfterInv != null;
        return new TestCase(regex, eq(), positive, invert(positive),negative, null, null,exceptionAfterInv, -1,  false,false);
    }

    static TestCase exAfterMinNG(String regex, Positive[] positive, Class<? extends Throwable> exceptionAfterMin,String... negative) {
        assert exceptionAfterMin != null;
        return new TestCase(regex, eq(), positive,invert(positive), negative, null, exceptionAfterMin, null,-1,  true,false);
    }

    static TestCase exNoMin(String regex, Class<? extends Throwable> exception, Positive[] positive, String... negative) {
        assert exception != null;
        return new TestCase(regex, eq(), positive,invert(positive), negative, exception, null, null,-1,  false,false);
    }

    static TestCase ex2(String regex, Class<? extends Throwable> exception) {
        return new TestCase(regex, eq(), null,null, null, exception, exception, null,-1,  false,false);
    }

    static TestCase t(String regex, Positive[] positive, String... negative) {
        return new TestCase("f=" + regex, eq(), positive,invert(positive), negative, null, null, null,-1, false,false);
    }

    static TestCase t(String regex, Positive[] positive,Inverted[] invertedPositive, String... negative) {
        return new TestCase("f=" + regex, eq(), positive, invertedPositive, negative, null, null, null,-1, false,false);
    }
    ...
    static TestCase tNG(String regex, Positive[] positive, String... negative) {
        return new TestCase("f=" + regex, eq(), positive,invert(positive), negative, null, null, null,-1,  true,false);
    }

    static TestCase t(String regex, int states, Positive[] positive, String... negative) {
        return new TestCase("f=" + regex, eq(), positive,invert(positive), negative, null, null, null,states, false,false);
    }

    static TestCase tEq(String regex, String[] eqRegex, int states, Positive[] positive, String... negative) {
        return new TestCase("f=" + regex, eqRegex, positive,invert(positive), negative, null, null, null,states, false,false);
    }

    static TestCase tNG(String regex, int states, Positive[] positive, String... negative) {
        return new TestCase("f=" + regex, eq(), positive,invert(positive), negative, null, null, null,states, true,false);
    }
    static TestCase f(String regex, Positive[] positive, String... negative) {
        return new TestCase(regex, eq(), positive,invert(positive), negative, null, null, null,-1, false,true);
    }
    static TestCase a(String regex, Positive[] positive, String... negative) {
        return new TestCase(regex, eq(), positive,invert(positive), negative, null, null, null,-1, false,false);
    }
    static TestCase aNG(String regex, Positive[] positive, String... negative) {
        return new TestCase(regex, eq(), positive,invert(positive), negative, null, null, null,-1,  true,false);
    }
    static TestCase aNG(String regex, int states, Positive[] positive, String... negative) {
        return new TestCase(regex, eq(), positive,invert(positive), negative, null, null, null,states,  true,false);
    }
    static TestCase a(String regex, int states, Positive[] positive, String... negative) {
        return new TestCase(regex, eq(), positive,invert(positive), negative, null, null, null,states, false,false);
    }
...
//                        ps("one;1","one;1","two;2","three;3","four;4","five;5","six;6","seven;7","eight;8","nine;9","ten;10","eleven;11","twelve;12","thirteen;13","fourteen;14","fifteen;15","sixteen;16","seventeen;17","eighteen;18","nineteen;19","twenty;20","twenty one;21","twenty two;22","twenty three;23","twenty four;24","twenty five;25","twenty six;26","twenty seven;27","twenty eight;28","twenty nine;29","thirty;30","thirty one;31","thirty two;32","thirty three;33","thirty four;34","thirty five;35","thirty six;36","thirty seven;37","thirty eight;38","thirty nine;39","forty;40","forty one;41","forty two;42","forty three;43","forty four;44","forty five;45","forty six;46","forty seven;47","forty eight;48","forty nine;49","fifty;50","fifty one;51","fifty two;52","fifty three;53","fifty four;54","fifty five;55","fifty six;56","fifty seven;57","fifty eight;58","fifty nine;59","sixty;60","sixty one;61","sixty two;62","sixty three;63","sixty four;64","sixty five;65","sixty six;66","sixty seven;67","sixty eight;68","sixty nine;69","seventy;70","seventy one;71","seventy two;72","seventy three;73","seventy four;74","seventy five;75","seventy six;76","seventy seven;77","seventy eight;78","seventy nine;79","eighty;80","eighty one;81","eighty two;82","eighty three;83","eighty four;84","eighty five;85","eighty six;86","eighty seven;87","eighty eight;88","eighty nine;89","ninety;90","ninety one;91","ninety two;92","ninety three;93","ninety four;94","ninety five;95","ninety six;96","ninety seven;97","ninety eight;98","ninety nine;99","one hundred;100","one hundred one;101","two hundred;200","three hundred fifty one;351","four hundred seventeen;417","five hundred seventy seven;577","six hundred forty five;645","seven hundred sixteen;716","eight hundred one;801","eight hundred forty;840","eight hundred forty one;841","eight hundred forty two;842","nine hundred seventy two;972","nine hundred seventy three;973","nine hundred seventy four;974","nine hundred seventy seven;977","nine hundred ninety four;994","nine hundred ninety five;995","nine hundred ninety nine;999")),
                exAfterInv("f = :'x' [a-z]",   ps("a;x","b;x"), CompilationError.RangeWithoutReflection.class,"", " "),
                exAfterInv("f = parseATT!('0 1 az 0 x','1 2 09 0 yy','2 3 a','2   0 k','3 0 _')",5,
                        ps("a0;xyyk","c5;xyyk","b3a_k7;xyyxyyk"),CompilationError.RangeWithoutReflection.class,"o","on","8",""),
                t("'a'", 2,  ps("a;"), "b", "c", "", " "),
                ...
                t("dict!('a':'be','':'re')", ps("a;be",";re"), "aa", "efr", "etrry"),
                t("dict!('a':'be','':'')", ps("a;be",";"), "aa", "efr", "etrry"),
                ...
                aNG("f = ostiaWithDomain!['abc'*]!('abc':'x')",
                        ps("abc;x"),"a","ab","o","on"),
                aNG("f = ostiaWithDomain![('ab'|'c')*]!('abc')",
                        ps("ab;","c;","abc;"),"a","o","on"),
                ...
                aNG("f = ostia!('one':'1','o':[],'on':[])",
                        ps("one;1","one;1"),"o","on"),
                aNG("f = ostiaCompress!('one':'1')",
                        ps("one;1"),"o","on",""),
                aNG("f = ostiaCompress!('one':'1','onee':'1')",
                        ps("one;1","onee;1"),"oneee","o","on",""),
                aNG("f = ostiaCompress!('one':'1','onee':'1','oneee':[])",
                        ps("one;1","onee;1"),"o","on","","oneee"),
                aNG("f = ostiaCompress!('a':'1','aa':'1')",
                        ps("a;1","aa;1"),"aaa","o","on","","oneee"),
                aNG("f = ostiaCompress!('ab','aa','ba','bb')",3,
                        ps("ab;","aa;","ba;","bb;"),"o","on","","oneee","aaa","a","b"),
                aNG("f = ostiaMaxOverlapCompress!('one':'1')",
                        ps("one;1","one;1"),"o","on",""),
                aNG("f = ostiaMaxOverlapCompress!('one':'1','onee':'1')",
                        ps("one;1","onee;1","oneee;1"),"o","on",""),
                aNG("f = ostiaMaxOverlapCompress!('one':'1','onee':'1','oneee':[])",
                        ps("one;1","onee;1"),"o","on","","oneee"),
                aNG("f = ostiaMaxDeepOverlapCompress!('one':'1','onee':'1')",
                        ps("one;1","onee;1"),"o","on","","oneee"),
                aNG("f = ostiaMaxOverlapCompress!('a':'1','aa':'1')",
                        ps("a;1","aa;1","aaa;1"),"o","on","","oneee"),
                aNG("f = ostiaMaxDeepOverlapCompress!('a':'1','aa':'1')",
                        ps("a;1","aa;1"),"o","on","","oneee","aaa"),
                aNG("f = ostiaMaxOverlapCompress!('ab','aa','ba','bb')",3,
                        ps("ab;","aa;","ba;","bb;"),"o","on","","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('ab','aa','ba','bb')",3,
                        ps("ab;","aa;","ba;","bb;"),"o","on","","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('s':'60','sd':'70')",
                        ps("s;60","sd;70"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('s':'60','su':'61','sd':'70','so':'71')",
                        ps("s;60","su;61","sd;70","so;71"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('u':'1','s':'60','su':'61','sd':'70','so':'71')",
                        ps("u;1","s;60","su;61","sd;70","so;71"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('z':'0','u':'1','s':'60','su':'61','sd':'70','so':'71')",
                        ps("z;0","u;1","s;60","su;61","sd;70","so;71"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','quatre':'4','cinq':'5','six':'6','sept':'7','huit':'8','neuf':'9','soixante':'60','soixante et un':'61','soixante-deux':'62','soixante-trois':'63','soixante-quatre':'64','soixante-cinq':'65','soixante-six':'66','soixante-sept':'67','soixante-huit':'68','soixante-neuf':'69')",
                        ps("zéro;0","un;1","deux;2","trois;3","quatre;4","cinq;5","six;6","sept;7","huit;8","neuf;9","soixante;60","soixante et un;61","soixante-deux;62","soixante-trois;63","soixante-quatre;64","soixante-cinq;65","soixante-six;66","soixante-sept;67","soixante-huit;68","soixante-neuf;69"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','soixante':'60','soixante et un':'61','soixante-dix':'70','soixante-et-onze':'71')",
                        ps("zéro;0","un;1","soixante;60","soixante et un;61","soixante-dix;70","soixante-et-onze;71"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','soixante':'60','soixante et un':'61','soixante-deux':'62','soixante-trois':'63','soixante-dix':'70','soixante-et-onze':'71','soixante-douze':'72','soixante-treize':'73')",
                        ps("zéro;0","un;1","deux;2","trois;3","soixante;60","soixante et un;61","soixante-deux;62","soixante-trois;63","soixante-dix;70","soixante-et-onze;71","soixante-douze;72","soixante-treize;73"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','quatre':'4','cinq':'5','six':'6','sept':'7','huit':'8','neuf':'9','soixante':'60','soixante et un':'61','soixante-deux':'62','soixante-trois':'63','soixante-quatre':'64','soixante-cinq':'65','soixante-six':'66','soixante-sept':'67','soixante-huit':'68','soixante-neuf':'69','soixante-dix':'70','soixante-et-onze':'71','soixante-douze':'72','soixante-treize':'73','soixante-quatorze':'74','soixante-quinze':'75','soixante-seize':'76','soixante-dix-sept':'77','soixante-dix-huit':'78','soixante-dix-neuf':'79')",
                        ps("zéro;0","un;1","deux;2","trois;3","quatre;4","cinq;5","six;6","sept;7","huit;8","neuf;9","soixante;60","soixante et un;61","soixante-deux;62","soixante-trois;63","soixante-quatre;64","soixante-cinq;65","soixante-six;66","soixante-sept;67","soixante-huit;68","soixante-neuf;69","soixante-dix;70","soixante-et-onze;71","soixante-douze;72","soixante-treize;73","soixante-quatorze;74","soixante-quinze;75","soixante-seize;76","soixante-dix-sept;77","soixante-dix-huit;78","soixante-dix-neuf;79"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','quatre':'4','cinq':'5','six':'6','sept':'7','huit':'8','neuf':'9','soixante':'60','soixante et un':'61','soixante-deux':'62','soixante-trois':'63','soixante-quatre':'64','soixante-cinq':'65','soixante-six':'66','soixante-sept':'67','soixante-huit':'68','soixante-neuf':'69','soixante-dix':'70','soixante-et-onze':'71','soixante-douze':'72','soixante-treize':'73','soixante-quatorze':'74','soixante-quinze':'75','soixante-seize':'76','soixante-dix-sept':'77','soixante-dix-huit':'78','soixante-dix-neuf':'79','quatre-vingts':'80','quatre-vingt-un':'81','quatre-vingt-deux':'82','quatre-vingt-trois':'83','quatre-vingt-quatre':'84','quatre-vingt-cinq':'85','quatre-vingt-six':'86','quatre-vingt-sept':'87','quatre-vingt-huit':'88','quatre-vingt-neuf':'89','quatre-vingt-dix':'90','quatre-vingt-onze':'91','quatre-vingt-douze':'92','quatre-vingt-treize':'93','quatre-vingt-quatorze':'94','quatre-vingt-quinze':'95','quatre-vingt-seize':'96','quatre-vingt-dix-sept':'97','quatre-vingt-dix-huit':'98','quatre-vingt-dix-neuf':'99','cent':'100')",
                        ps("zéro;0","un;1","deux;2","trois;3","quatre;4","cinq;5","six;6","sept;7","huit;8","neuf;9","soixante;60","soixante et un;61","soixante-deux;62","soixante-trois;63","soixante-quatre;64","soixante-cinq;65","soixante-six;66","soixante-sept;67","soixante-huit;68","soixante-neuf;69","soixante-dix;70","soixante-et-onze;71","soixante-douze;72","soixante-treize;73","soixante-quatorze;74","soixante-quinze;75","soixante-seize;76","soixante-dix-sept;77","soixante-dix-huit;78","soixante-dix-neuf;79","quatre-vingts;80","quatre-vingt-un;81","quatre-vingt-deux;82","quatre-vingt-trois;83","quatre-vingt-quatre;84","quatre-vingt-cinq;85","quatre-vingt-six;86","quatre-vingt-sept;87","quatre-vingt-huit;88","quatre-vingt-neuf;89","quatre-vingt-dix;90","quatre-vingt-onze;91","quatre-vingt-douze;92","quatre-vingt-treize;93","quatre-vingt-quatorze;94","quatre-vingt-quinze;95","quatre-vingt-seize;96","quatre-vingt-dix-sept;97","quatre-vingt-dix-huit;98","quatre-vingt-dix-neuf;99","cent;100"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3')",
                        ps("zéro;0","un;1","deux;2","trois;3"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','cinquante-huit':'58','cinquante-neuf':'59','soixante':'60')",
                        36,
                        ps("zéro;0","un;1","deux;2","trois;3","cinquante-huit;58","cinquante-neuf;59","soixante;60"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b","oee"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','quarante-huit':'48','quarante-neuf':'49','cinquante':'50','cinquante et un':'51','cinquante-deux':'52','cinquante-trois':'53','cinquante-quatre':'54','cinquante-cinq':'55','cinquante-six':'56','cinquante-sept':'57','cinquante-huit':'58','cinquante-neuf':'59','soixante':'60')",
                        58,
                        ps("zéro;0","un;1","deux;2","trois;3","quarante-huit;48","quarante-neuf;49","cinquante;50","cinquante et un;51","cinquante-deux;52","cinquante-trois;53","cinquante-quatre;54","cinquante-cinq;55","cinquante-six;56","cinquante-sept;57","cinquante-huit;58","cinquante-neuf;59","soixante;60"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','Trente-huit':'38','Trente-neuf':'39','quarante':'40','quarante et un':'41','quarante-deux':'42','quarante-trois':'43','quarante-quatre':'44','quarante-cinq':'45','quarante-six':'46','quarante-sept':'47','quarante-huit':'48','quarante-neuf':'49','cinquante':'50','cinquante et un':'51','cinquante-deux':'52','cinquante-trois':'53','cinquante-quatre':'54','cinquante-cinq':'55','cinquante-six':'56','cinquante-sept':'57','cinquante-huit':'58','cinquante-neuf':'59','soixante':'60')",
                        59,
                        ps("zéro;0","un;1","deux;2","trois;3","Trente-huit;38","Trente-neuf;39","quarante;40","quarante et un;41","quarante-deux;42","quarante-trois;43","quarante-quatre;44","quarante-cinq;45","quarante-six;46","quarante-sept;47","quarante-huit;48","quarante-neuf;49","cinquante;50","cinquante et un;51","cinquante-deux;52","cinquante-trois;53","cinquante-quatre;54","cinquante-cinq;55","cinquante-six;56","cinquante-sept;57","cinquante-huit;58","cinquante-neuf;59","soixante;60"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','vingt-six':'26','vingt-sept':'27','vingt-huit':'28','vingt-neuf':'29','trente':'30','Trente et un':'31','Trente-deux':'32','Trente-trois':'33','Trente-quatre':'34','Trente-cinq':'35','Trente-six':'36','Trente-sept':'37','Trente-huit':'38','Trente-neuf':'39','quarante':'40','quarante et un':'41','quarante-deux':'42','quarante-trois':'43','quarante-quatre':'44','quarante-cinq':'45','quarante-six':'46','quarante-sept':'47','quarante-huit':'48','quarante-neuf':'49','cinquante':'50','cinquante et un':'51','cinquante-deux':'52','cinquante-trois':'53','cinquante-quatre':'54','cinquante-cinq':'55','cinquante-six':'56','cinquante-sept':'57','cinquante-huit':'58','cinquante-neuf':'59','soixante':'60')",
                        66,
                        ps("zéro;0","un;1","deux;2","trois;3","vingt-six;26","vingt-sept;27","vingt-huit;28","vingt-neuf;29","trente;30","Trente et un;31","Trente-deux;32","Trente-trois;33","Trente-quatre;34","Trente-cinq;35","Trente-six;36","Trente-sept;37","Trente-huit;38","Trente-neuf;39","quarante;40","quarante et un;41","quarante-deux;42","quarante-trois;43","quarante-quatre;44","quarante-cinq;45","quarante-six;46","quarante-sept;47","quarante-huit;48","quarante-neuf;49","cinquante;50","cinquante et un;51","cinquante-deux;52","cinquante-trois;53","cinquante-quatre;54","cinquante-cinq;55","cinquante-six;56","cinquante-sept;57","cinquante-huit;58","cinquante-neuf;59","soixante;60"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','quatre':'4','cinq':'5','six':'6','sept':'7','huit':'8','neuf':'9','dix':'10','onze':'11','douze':'12','treize':'13','quatorze':'14','quinze':'15','seize':'16','dix-sept':'17','dix-huit':'18','dix-neuf':'19','vingt':'20','vingt et un':'21','vingt-deux':'22','vingt-trois':'23','vingt-quatre':'24','vingt-cinq':'25','vingt-six':'26','vingt-sept':'27','vingt-huit':'28','vingt-neuf':'29','trente':'30','Trente et un':'31','Trente-deux':'32','Trente-trois':'33','Trente-quatre':'34','Trente-cinq':'35','Trente-six':'36','Trente-sept':'37','Trente-huit':'38','Trente-neuf':'39','quarante':'40','quarante et un':'41','quarante-deux':'42','quarante-trois':'43','quarante-quatre':'44','quarante-cinq':'45','quarante-six':'46','quarante-sept':'47','quarante-huit':'48','quarante-neuf':'49','cinquante':'50','cinquante et un':'51','cinquante-deux':'52','cinquante-trois':'53','cinquante-quatre':'54','cinquante-cinq':'55','cinquante-six':'56','cinquante-sept':'57','cinquante-huit':'58','cinquante-neuf':'59','soixante':'60')",
                        76,
                        ps("zéro;0","un;1","deux;2","trois;3","quatre;4","cinq;5","six;6","sept;7","huit;8","neuf;9","dix;10","onze;11","douze;12","treize;13","quatorze;14","quinze;15","seize;16","dix-sept;17","dix-huit;18","dix-neuf;19","vingt;20","vingt et un;21","vingt-deux;22","vingt-trois;23","vingt-quatre;24","vingt-cinq;25","vingt-six;26","vingt-sept;27","vingt-huit;28","vingt-neuf;29","trente;30","Trente et un;31","Trente-deux;32","Trente-trois;33","Trente-quatre;34","Trente-cinq;35","Trente-six;36","Trente-sept;37","Trente-huit;38","Trente-neuf;39","quarante;40","quarante et un;41","quarante-deux;42","quarante-trois;43","quarante-quatre;44","quarante-cinq;45","quarante-six;46","quarante-sept;47","quarante-huit;48","quarante-neuf;49","cinquante;50","cinquante et un;51","cinquante-deux;52","cinquante-trois;53","cinquante-quatre;54","cinquante-cinq;55","cinquante-six;56","cinquante-sept;57","cinquante-huit;58","cinquante-neuf;59","soixante;60"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b"),
                aNG("f = ostiaMaxDeepOverlapCompress!('zéro':'0','un':'1','deux':'2','trois':'3','quatre':'4','cinq':'5','six':'6','sept':'7','huit':'8','neuf':'9','dix':'10','onze':'11','douze':'12','treize':'13','quatorze':'14','quinze':'15','seize':'16','dix-sept':'17','dix-huit':'18','dix-neuf':'19','vingt':'20','vingt et un':'21','vingt-deux':'22','vingt-trois':'23','vingt-quatre':'24','vingt-cinq':'25','vingt-six':'26','vingt-sept':'27','vingt-huit':'28','vingt-neuf':'29','trente':'30','Trente et un':'31','Trente-deux':'32','Trente-trois':'33','Trente-quatre':'34','Trente-cinq':'35','Trente-six':'36','Trente-sept':'37','Trente-huit':'38','Trente-neuf':'39','quarante':'40','quarante et un':'41','quarante-deux':'42','quarante-trois':'43','quarante-quatre':'44','quarante-cinq':'45','quarante-six':'46','quarante-sept':'47','quarante-huit':'48','quarante-neuf':'49','cinquante':'50','cinquante et un':'51','cinquante-deux':'52','cinquante-trois':'53','cinquante-quatre':'54','cinquante-cinq':'55','cinquante-six':'56','cinquante-sept':'57','cinquante-huit':'58','cinquante-neuf':'59','soixante':'60','soixante et un':'61','soixante-deux':'62','soixante-trois':'63','soixante-quatre':'64','soixante-cinq':'65','soixante-six':'66','soixante-sept':'67','soixante-huit':'68','soixante-neuf':'69','soixante-dix':'70','soixante-et-onze':'71','soixante-douze':'72','soixante-treize':'73','soixante-quatorze':'74','soixante-quinze':'75','soixante-seize':'76','soixante-dix-sept':'77','soixante-dix-huit':'78','soixante-dix-neuf':'79','quatre-vingts':'80','quatre-vingt-un':'81','quatre-vingt-deux':'82','quatre-vingt-trois':'83','quatre-vingt-quatre':'84','quatre-vingt-cinq':'85','quatre-vingt-six':'86','quatre-vingt-sept':'87','quatre-vingt-huit':'88','quatre-vingt-neuf':'89','quatre-vingt-dix':'90','quatre-vingt-onze':'91','quatre-vingt-douze':'92','quatre-vingt-treize':'93','quatre-vingt-quatorze':'94','quatre-vingt-quinze':'95','quatre-vingt-seize':'96','quatre-vingt-dix-sept':'97','quatre-vingt-dix-huit':'98','quatre-vingt-dix-neuf':'99','cent':'100')",112,
                        ps("zéro;0","un;1","deux;2","trois;3","quatre;4","cinq;5","six;6","sept;7","huit;8","neuf;9","dix;10","onze;11","douze;12","treize;13","quatorze;14","quinze;15","seize;16","dix-sept;17","dix-huit;18","dix-neuf;19","vingt;20","vingt et un;21","vingt-deux;22","vingt-trois;23","vingt-quatre;24","vingt-cinq;25","vingt-six;26","vingt-sept;27","vingt-huit;28","vingt-neuf;29","trente;30","Trente et un;31","Trente-deux;32","Trente-trois;33","Trente-quatre;34","Trente-cinq;35","Trente-six;36","Trente-sept;37","Trente-huit;38","Trente-neuf;39","quarante;40","quarante et un;41","quarante-deux;42","quarante-trois;43","quarante-quatre;44","quarante-cinq;45","quarante-six;46","quarante-sept;47","quarante-huit;48","quarante-neuf;49","cinquante;50","cinquante et un;51","cinquante-deux;52","cinquante-trois;53","cinquante-quatre;54","cinquante-cinq;55","cinquante-six;56","cinquante-sept;57","cinquante-huit;58","cinquante-neuf;59","soixante;60","soixante et un;61","soixante-deux;62","soixante-trois;63","soixante-quatre;64","soixante-cinq;65","soixante-six;66","soixante-sept;67","soixante-huit;68","soixante-neuf;69","soixante-dix;70","soixante-et-onze;71","soixante-douze;72","soixante-treize;73","soixante-quatorze;74","soixante-quinze;75","soixante-seize;76","soixante-dix-sept;77","soixante-dix-huit;78","soixante-dix-neuf;79","quatre-vingts;80","quatre-vingt-un;81","quatre-vingt-deux;82","quatre-vingt-trois;83","quatre-vingt-quatre;84","quatre-vingt-cinq;85","quatre-vingt-six;86","quatre-vingt-sept;87","quatre-vingt-huit;88","quatre-vingt-neuf;89","quatre-vingt-dix;90","quatre-vingt-onze;91","quatre-vingt-douze;92","quatre-vingt-treize;93","quatre-vingt-quatorze;94","quatre-vingt-quinze;95","quatre-vingt-seize;96","quatre-vingt-dix-sept;97","quatre-vingt-dix-huit;98","quatre-vingt-dix-neuf;99","cent;100"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b","oee"),
                a("f = activeLearningFromDataset!('algorithm':'ostia_max_deep_overlap_compress','firstBatchCount':'-1','batchSize':'5','datasetPath':'src/test/resources/f/fr_numerals.py','arg':'100')",
                        101,
                        ps("un;1","deux;2","trois;3","quatre;4","cinq;5","six;6","sept;7","huit;8","neuf;9","dix;10","onze;11","douze;12","treize;13","quatorze;14","quinze;15","seize;16","dix-sept;17","dix-huit;18","dix-neuf;19","vingt;20","vingt et un;21","vingt-deux;22","vingt-trois;23","vingt-quatre;24","vingt-cinq;25","vingt-six;26","vingt-sept;27","vingt-huit;28","vingt-neuf;29","trente;30","trente et un;31","trente-deux;32","trente-trois;33","trente-quatre;34","trente-cinq;35","trente-six;36","trente-sept;37","trente-huit;38","trente-neuf;39","quarante;40","quarante et un;41","quarante-deux;42","quarante-trois;43","quarante-quatre;44","quarante-cinq;45","quarante-six;46","quarante-sept;47","quarante-huit;48","quarante-neuf;49","cinquante;50","cinquante et un;51","cinquante-deux;52","cinquante-trois;53","cinquante-quatre;54","cinquante-cinq;55","cinquante-six;56","cinquante-sept;57","cinquante-huit;58","cinquante-neuf;59","soixante;60","soixante et un;61","soixante-deux;62","soixante-trois;63","soixante-quatre;64","soixante-cinq;65","soixante-six;66","soixante-sept;67","soixante-huit;68","soixante-neuf;69","soixante-dix;70","soixante-et-onze;71","soixante-douze;72","soixante-treize;73","soixante-quatorze;74","soixante-quinze;75","soixante-seize;76","soixante-dix-sept;77","soixante-dix-huit;78","soixante-dix-neuf;79","quatre-vingts;80","quatre-vingt-un;81","quatre-vingt-deux;82","quatre-vingt-trois;83","quatre-vingt-quatre;84","quatre-vingt-cinq;85","quatre-vingt-six;86","quatre-vingt-sept;87","quatre-vingt-huit;88","quatre-vingt-neuf;89","quatre-vingt-dix;90","quatre-vingt-onze;91","quatre-vingt-douze;92","quatre-vingt-treize;93","quatre-vingt-quatorze;94","quatre-vingt-quinze;95","quatre-vingt-seize;96","quatre-vingt-dix-sept;97","quatre-vingt-dix-huit;98","quatre-vingt-dix-neuf;99"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b","oee"),
                a("f = activeLearningFromDataset!('algorithm':'ostia_compress','firstBatchCount':'-1','batchSize':'5','datasetPath':'src/test/resources/f/fr_numerals.py','arg':'100')",
                        101,
                        ps("un;1","deux;2","trois;3","quatre;4","cinq;5","six;6","sept;7","huit;8","neuf;9","dix;10","onze;11","douze;12","treize;13","quatorze;14","quinze;15","seize;16","dix-sept;17","dix-huit;18","dix-neuf;19","vingt;20","vingt et un;21","vingt-deux;22","vingt-trois;23","vingt-quatre;24","vingt-cinq;25","vingt-six;26","vingt-sept;27","vingt-huit;28","vingt-neuf;29","trente;30","trente et un;31","trente-deux;32","trente-trois;33","trente-quatre;34","trente-cinq;35","trente-six;36","trente-sept;37","trente-huit;38","trente-neuf;39","quarante;40","quarante et un;41","quarante-deux;42","quarante-trois;43","quarante-quatre;44","quarante-cinq;45","quarante-six;46","quarante-sept;47","quarante-huit;48","quarante-neuf;49","cinquante;50","cinquante et un;51","cinquante-deux;52","cinquante-trois;53","cinquante-quatre;54","cinquante-cinq;55","cinquante-six;56","cinquante-sept;57","cinquante-huit;58","cinquante-neuf;59","soixante;60","soixante et un;61","soixante-deux;62","soixante-trois;63","soixante-quatre;64","soixante-cinq;65","soixante-six;66","soixante-sept;67","soixante-huit;68","soixante-neuf;69","soixante-dix;70","soixante-et-onze;71","soixante-douze;72","soixante-treize;73","soixante-quatorze;74","soixante-quinze;75","soixante-seize;76","soixante-dix-sept;77","soixante-dix-huit;78","soixante-dix-neuf;79","quatre-vingts;80","quatre-vingt-un;81","quatre-vingt-deux;82","quatre-vingt-trois;83","quatre-vingt-quatre;84","quatre-vingt-cinq;85","quatre-vingt-six;86","quatre-vingt-sept;87","quatre-vingt-huit;88","quatre-vingt-neuf;89","quatre-vingt-dix;90","quatre-vingt-onze;91","quatre-vingt-douze;92","quatre-vingt-treize;93","quatre-vingt-quatorze;94","quatre-vingt-quinze;95","quatre-vingt-seize;96","quatre-vingt-dix-sept;97","quatre-vingt-dix-huit;98","quatre-vingt-dix-neuf;99"),"quatre-vingt-dix-neu","quatre-vingt-d","quatre-vi","quatre-vingt-dix-ne","quatre-vingt-dix-neufe","dixa","dix-","-","o","on","","ce","c","cen","d","di","q","qu","oneee","aaa","a","b","oee"),
        ...
        for (TestCase testCase : testCases) {
            ...
            try {
                ...
                if(testCase.readFromFile){
                    tr.parse(CharStreams.fromFileName(testCase.regex));
                }else{
                    tr.parse(CharStreams.fromString(testCase.regex));
                }
                ...
                try {
                    ...
                    assertNull("INV idx=" + i + "\nregex=" + testCase.regex + "\n" + g + "\n\n" + o,testCase.exceptionDuringInversion);
                    assertNotNull("INV idx=" + i + "\nregex=" + testCase.regex + "\n" + g + "\n\n" + o, testCase.invertedPositive);

                } catch (CompilationError e) {
                    if(testCase.exceptionDuringInversion!=null){
                        assertEquals("INV idx=" + i + "\nregex=" + testCase.regex + "\n" + g + "\n\n" + o + "\n",testCase.exceptionDuringInversion,e.getClass());
                    }
...
//        System.out.print(str);
    ...
    void testOSTIA() throws Exception {
        ...
        for (int i = 1; i < testCount; i++) {
            ...
            final Specification.RangedGraph<IntSeq, Integer, E, P> learned = tr.specs.convertCustomGraphToRanged(OSTIAState.asGraph(tr.specs,init, idx->idx+'a', OSTIA.State::shortest), E::getToInclusive);
            for(Pair<IntSeq, IntSeq> pair:informant){
...
//            }
    ...
    void testPipelines() throws Exception {
        PipelineTestCase[] cases = {
                ...
                p("@f = (.* 2{ 1{'a':<0> . 'a' 2} } .* 1)* ; {1->'a':'x'|'b':'y'|'c':'z' 2-> (:<0> .)*} ; (:<0> .)*", ps("aaa;x","aba;y","aca;z","kybfeggabager;y","kabaybfeggabager;yy","kaaaybacafeggabager;xzy")),
                p("@f = (.* 2{ 1{'a':<0> . 'a' 2} } .* 1)* ; {1->'a':'x'|'b':'y'|'c':'z' 2-> (:<0> .)* ; (:<0> .)*} ; (:<0> .)*", ps("aaa;x","aba;y","aca;z","kybfeggabager;y","kabaybfeggabager;yy","kaaaybacafeggabager;xzy")),
                p("@f = (.* 2{ 1{'a':<0> . 'a' 2} } .* 1)* ; {1-> (:<0> .)* ; 'a':'x'|'b':'y'|'c':'z' 2-> (:<0> .)* ; (:<0> .)*} ; (:<0> .)*", ps("aaa;x","aba;y","aca;z","kybfeggabager;y","kabaybfeggabager;yy","kaaaybacafeggabager;xzy")),
                p("@f = (.* 2{ 1{'a':<0> . 'a' 2} } .* 1)* ; {1-> (:<0> .)* ; 'a':'x'|'b':'y'|'c':'z' 2-> (:<0> .)* ; (:<0> .)*} ; (:<0> .)* ; { 1->(:<0> .)* 2-> (:<0> .)* 3-> (:<0> .)* 4 -> (:<0> .)* }", ps("aaa;x","aba;y","aca;z","kybfeggabager;y","kabaybfeggabager;yy","kaaaybacafeggabager;xzy")),
                ...
                p("@f = 'a':'b'; 'b' : 'c' ; 'c' : 'd' || 'x':'y' || 'y':'z' || 'z':'a'", ps("a;d","x;y","y;z","z;a"), "", "b", "c", "d", "aa"),
