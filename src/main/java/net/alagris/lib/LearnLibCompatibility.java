...
public class LearnLibCompatibility {
    ...
    LearningFramework<Pair<Alphabet<Integer>, DFA<?, Integer>>, Pos, LexUnicodeSpecification.E, LexUnicodeSpecification.P, Integer, N, G>
    asLearningFramework(LexUnicodeSpecification<N, G> specs,
                        Function<List<Pair<IntSeq, IntSeq>>, Pair<Alphabet<Integer>, DFA<?, Integer>>> learn) {
        return new LearningFramework<Pair<Alphabet<Integer>, DFA<?, Integer>>, Pos, LexUnicodeSpecification.E, LexUnicodeSpecification.P, Integer, N, G>() {
            @Override
            public Pair<Alphabet<Integer>, DFA<?, Integer>> makeHypothesis(List<Pair<IntSeq, IntSeq>> text) {
            ...
            optimiseHypothesis(Pair<Alphabet<Integer>, DFA<?, Integer>> hypothesis) {
                return specs.convertCustomGraphToRanged(asGraph(specs, hypothesis.r(),hypothesis.l() , o -> Pos.NONE),LexUnicodeSpecification.E::getToExclsuive);
            }
        };
    }

    public static <N, G extends IntermediateGraph<Pos, LexUnicodeSpecification.E, LexUnicodeSpecification.P, N>>
    LearningFramework<Pair<Alphabet<Integer>, MealyMachine<?, Integer, ?, Integer>>, Pos, LexUnicodeSpecification.E, LexUnicodeSpecification.P, Integer, N, G>
    asLearningFrameworkMealy(LexUnicodeSpecification<N, G> specs) {
        return new LearningFramework<Pair<Alphabet<Integer>, MealyMachine<?, Integer, ?, Integer>>, Pos, LexUnicodeSpecification.E, LexUnicodeSpecification.P, Integer, N, G>() {
            @Override
            public Pair<Alphabet<Integer>, MealyMachine<?, Integer, ?, Integer>> makeHypothesis(List<Pair<IntSeq, IntSeq>> text) {
                return rpniMealy(text);
            }
            ...
            optimiseHypothesis(Pair<Alphabet<Integer>, MealyMachine<?, Integer, ?, Integer>> hypothesis) {
                return specs.convertCustomGraphToRanged(asGraphMealy(specs, hypothesis.r(),hypothesis.l() , IntSeq::new,o -> Pos.NONE),LexUnicodeSpecification.E::getToExclsuive);
            }
        };
    }
