...
public abstract class LexUnicodeSpecification<N, G extends IntermediateGraph<Pos, E, P, N>>
	...
	public ParserListener<LexPipeline<N, G>, Pos, E, P, Integer, IntSeq, Integer, N, G> makeParser(
			Collection<ParserListener.Type<Pos, E, P, N, G>> types) {
	 ...
	 */
	public void typecheck(String name, Pos graphPos, Pos typePos, ParserListener.TypeConstructor constructor,
			RangedGraph<Pos, Integer, E, P> graph, RangedGraph<Pos, Integer, E, P> typeLhs,
		...
		assert constructor == ParserListener.TypeConstructor.FUNCTION
				|| constructor == ParserListener.TypeConstructor.PRODUCT : constructor;
