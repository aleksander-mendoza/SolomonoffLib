...
public class ArrayIntermediateGraph<V, E, P> implements IntermediateGraph<V, E, P, ArrayIntermediateGraph.N<V, E>> {
	...
	public static class LexUnicodeSpecification extends
            net.alagris.core.LexUnicodeSpecification<N<Pos, net.alagris.core.LexUnicodeSpecification.E>, ArrayIntermediateGraph<Pos, net.alagris.core.LexUnicodeSpecification.E, net.alagris.core.LexUnicodeSpecification.P>> {
