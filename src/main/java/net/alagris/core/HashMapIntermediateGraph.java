...
public class HashMapIntermediateGraph<V, E, P> implements IntermediateGraph<V, E, P, HashMapIntermediateGraph.N<V, E>> {
    ...
    public static class LexUnicodeSpecification extends net.alagris.core.LexUnicodeSpecification<
                N<Pos, net.alagris.core.LexUnicodeSpecification.E>,
                HashMapIntermediateGraph<Pos, net.alagris.core.LexUnicodeSpecification.E, net.alagris.core.LexUnicodeSpecification.P>> {
